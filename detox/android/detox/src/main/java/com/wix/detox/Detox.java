...
public final class Detox {
    ...
    private static final LaunchIntentHelper sIntentsHelper = new LaunchIntentHelper();
    ...
    public static void launchMainActivity() {
        ...
        launchActivitySync(sIntentsHelper.activityLaunchIntent(activity));
    }

    public static void startActivityFromUrl(String url) {
        launchActivitySync(sIntentsHelper.intentWithUrl(url, false));
    }
    ...
    private static Intent extractInitialIntent() {
        ...
        if (sLaunchArgs.hasUrlOverride()) {
            intent = sIntentsHelper.intentWithUrl(sLaunchArgs.getUrlOverride(), true);
        } else {
            intent = sIntentsHelper.cleanIntent();
        }
